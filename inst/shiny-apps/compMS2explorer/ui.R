                ...
                shiny::conditionalPanel(condition="input.tabbedPanelButton >'0' & input.FeatureNames!='No MS2 features found'", 
                                        shiny::tabsetPanel(
                                          shiny::tabPanel('Composite MS2 plot', 
                                                       ...
                                                       DT::dataTableOutput("compMS2tableInfo")),
                                          ...
                                          shiny::tabPanel('Correlation network plot', shiny::verbatimTextOutput("nNodesEdges"), splitLayout(cellWidths = c('70%', '30%'), shiny::plotOutput("network_plot", height = "800px", brush = 'network_brush'), DT::dataTableOutput("networkTableBrush"))),                          
