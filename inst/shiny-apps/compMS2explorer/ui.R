...
shiny::shinyUI(shiny::fluidPage(
  ...
  shiny::fluidRow(shiny::column(shiny::h4("Options"), width=2, 
                                ...
                                shiny::selectInput("subStrAnnoTypes", label=shiny::tags$b("substructure type annotation above summed relative intensity threshold (multiple combinations) :"), choices=c(" ", subStrAnno.inputs), multiple=T), 
