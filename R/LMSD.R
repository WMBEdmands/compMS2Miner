...
#'
#' This dataset contains fields from the LMSD database (\url{http://www.lipidmaps.org/data/structure/index.html})
...
#'  entry e.g. Web address : "LMFA00000001" +
#'  Unique_DB_ID : "LMFA00000001" = \url{http://www.lipidmaps.org/data/LMSDRecord.php?LMID=LMFA00000001})
#'  \item Unique_DB_ID. LMSD unique reference number 
#'  \item name. LMSD entry name
#'  \item monoisotopic_weight. Monoisotopic weight of LMSD entry 
#'  (58.04187 -- 1199.439)
#'  \item SMILES. Canonical SMILES code of LMSD entry (converted from sdf file using the \code{\link{ChemmineR::sdf2smiles}})
...
#' @name LMSD
#' @usage data(LMSD)
#' @source \url{http://www.lipidmaps.org/resources/downloads/index.html} 
#' \enumerate{
#' \item Sud M, Fahy E, Cotter D, Brown A, Dennis EA, Glass CK, Merrill AH Jr, Murphy RC, Raetz CR, Russell DW, Subramaniam S. LMSD: LIPID MAPS structure database Nucleic Acids Research 35: p. D527-32. PMID:17098933 [doi:10.1093/nar/gkl838] PMID: 17098933 
#' \item Fahy E, Sud M, Cotter D & Subramaniam S. LIPID MAPS online tools for lipid research Nucleic Acids Research (2007) 35: p. W606-12.PMID:17584797 [doi:10.1093/nar/gkm324] PMID: 17584797
#' }
#' @format A data frame with 34127 rows and 294 columns
NULL
